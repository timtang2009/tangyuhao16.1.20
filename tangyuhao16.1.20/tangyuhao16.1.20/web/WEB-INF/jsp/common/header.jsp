...
<head>
    ...
    <script type="text/javascript" src="http://192.168.0.130/public/js/jquery-1.4.2.min.js"></script>
    <script type="text/javascript" src="http://192.168.0.130/public/js/fns.js"></script>
    <script type="text/javascript" src="http://192.168.0.130/public/js/formValidateNew.js"></script>
...
<div class="headerWrap">
    <div class="header clearfix">
		...
		<span class="right mt_10 pt_5">
            ...
            <c:if test="${SESSION_USER_V2 != null}">
                <a href="#" class="white ">欢迎，${SESSION_USER_V2.name}</a>
